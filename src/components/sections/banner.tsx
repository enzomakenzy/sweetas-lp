...
export function Banner() {
  return (
    <section className="grid grid-cols-1 px-3 pt-28 lg:pt-34 md:px-11 lg:px-27 lg:grid-cols-2 lg:gap-6 lg:items-center">
      ...
      <div className="pr-3 lg:pr-0">
        <div className="relative shadow-lg rounded-xl sm:max-w-140 lg:max-w-204 m-auto">
