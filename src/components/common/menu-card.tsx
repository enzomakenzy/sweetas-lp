...
export function MenuCard({ favlorName, price, description, image, imageAlt }: Props) {
  return (
    <div className="rounded-2xl overflow-hidden border-2 border-quaternary/50 relative transition-all duration-400 lg:max-w-full bg-card lg:hover:border-primary lg:hover:-translate-y-2 group">
