...
export function Top3Card({ position, favlorName, description, image, imageAlt, className }: Props) {
  ...
  return (
    <div className={`${position === 1 ? "bg-primary" : "bg-background"} rounded-2xl px-5 py-6 flex flex-col gap-5 shadow lg:hover:-xl relative overflow-hidden transition lg:hover:-translate-y-3 duration-400 group ${className}`}>
