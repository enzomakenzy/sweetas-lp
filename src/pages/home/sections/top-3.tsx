...
export function Top3() {
  return (
    <section className="px-10 pt-16 md:px-11 lg:px-12 bg-background pb-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14 lg:flex-row lg:items-end">
          <Top3Circle
            position={1} 
